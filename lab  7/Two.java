...
public class Two
{
    ...
    {
        Person person=new Person("Pirih","Wapda TPS Guddu");
        Student student=new Student("Mahnoor","Wapda TPS Guddu","Software Engineering",2018, 940000);
        Staff staff=new Staff("Hassnain","Hyderabad","MUET", 50000);
